    ...
    val tickEvent =
        listenEvent<TickEvent, Unit> { _ ->
            ...
            minecraft.level?.entities?.get(minecraft.player!!.radiusBox(50)) { entity ->
                ...
                val location: HollowsLocation? =
                    when {
                        name?.contains("King Yolkar") == true ->
                            HollowsLocation(
                                entityPos,
                                PreDefinedHollowsLocationSpecific.GOBLIN_KING
                            )
                        name?.contains("Professor Robot") == true ->
                            HollowsLocation(
                        ...
                        customName?.contains("Team Treasurite") == true && entity.hasMaxHealth(1_000_000f) ->
                            HollowsLocation(
                                entityPos,
                                PreDefinedHollowsLocationSpecific.CORLEONE
                            )
