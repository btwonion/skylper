...
class HollowsStructureWaypoint(private val wPos: Vec3, private val structure: HollowsStructure, private val respectY: Boolean = true) : Waypoint(
    ...
    override fun render(context: WorldRenderContext?) {
        RenderHelperInvoker.invokeRenderBeaconBeam(context, if (respectY) pos.atY(structure.minY) else pos.atY(0), colorComponents)
