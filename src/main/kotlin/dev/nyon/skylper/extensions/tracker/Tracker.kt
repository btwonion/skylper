...
abstract class Tracker<D : TrackerData>(val nameSpace: String, val data: D) : SimpleHudWidget(
    Component.translatable("menu.skylper.overlay.${nameSpace}.title").withStyle { it.withColor(ChatFormatting.AQUA) }) {
