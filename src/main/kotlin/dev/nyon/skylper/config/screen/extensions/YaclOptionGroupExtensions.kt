...
fun OptionGroup.Builder.title(categoryKey: String, key: String): OptionGroup.Builder {
    name(Component.translatable("menu.skylper.config.$categoryKey.$key.title"))
    return this
}

fun OptionGroup.Builder.description(categoryKey: String, key: String, vararg args: Any) {
